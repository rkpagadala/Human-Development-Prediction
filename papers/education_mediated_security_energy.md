...
The MDG/SDG achievements that did occur — documented child mortality reductions, maternal mortality improvements, hunger reduction — are not evidence that this ordering is correct. They are evidence that the global educational rupture since 1950 produced the institutional capacity to deliver welfare internationally: the WHO, UNICEF, PEPFAR, the Global Fund, and GAVI are staffed and led by educated workers from educated countries, deploying welfare technology to populations without yet the domestic educational base to generate it themselves. The SDG goals are not goals constructed by populations that lack education — they are goals constructed by the educated class in developed countries, delivered to less-educated countries as global PTE. The achievements are real; their causal interpretation is wrong. They are not proof that provision works without education. They are proof that when a sufficiently educated global class exists, it can export welfare gains to populations at low completion levels — temporarily, externally, and without changing the underlying trajectory unless domestic educational investment follows.
...
The mechanism can also operate at supranational scale. Where a country lacks the domestic educational base to generate PTE-mediated welfare improvement from within, international institutions staffed by educated workers from educated countries can deliver welfare technology — vaccines, oral rehydration protocols, nutrition programmes — that produces welfare gains the domestic educational base could not yet sustain independently. This is what we term *global PTE*: the global educated class acting, collectively, as an educated parent for populations at low completion levels. It is still education-mediated; the education is simply located in the institutions delivering the intervention rather than in the households receiving it. The critical distinction is that global PTE produces welfare gains that are externally sustained — durable only as long as the international institutions maintain them — while domestic PTE produces gains that compound into the next generation. Global PTE buys time; domestic PTE changes trajectory.

### 2.4 Energy as Physical Substrate

The argument that education is the sole primary driver of human development must be distinguished from the claim that physical resources are irrelevant. They are not. Energy — the physical capacity of a civilization to do work — sets the ceiling on what any society can achieve materially. All economic transactions are, at their physical foundation, energy conversion events: manufacturing moves atoms, transport moves mass, health systems require cold chains and pharmaceutical supply chains, schools require heated buildings and printed materials. No economic activity occurs without energy input. This is thermodynamics, not metaphor.

The relationship between energy and education is hierarchical, not competitive. Energy is the substrate; education is the efficiency multiplier that determines how much of the energy ceiling a society actually reaches, and whether the gains compound into the next generation. The decisive evidence comes from opposite ends of the resource spectrum.

**Energy without education: the resource curse.** Venezuela holds the world's largest proven oil reserves. The Democratic Republic of Congo holds uranium, cobalt, coltan, and gold — inputs to the energy and technology supply chains of the developed world. Saudi Arabia, Kuwait, and Qatar have extracted trillion-dollar oil revenues over fifty years. None has crossed both development thresholds as defined in Section 3 through domestic compounding. Qatar's lower secondary completion lags its generational baseline by 3.7pp in 2015 (authors' FE residuals, WCDE v3): the energy endowment produced income; it did not produce the educated population that turns income into compounding human welfare. Venezuela crossed both thresholds briefly in the early 2000s on oil-funded provision — then, as oil prices collapsed after 2014, GDP fell 35% in three years, hyperinflation exceeded 1,000,000%, and seven million people fled. Provision built on energy rents is as fragile as provision built on political will: when the rent stops, the gains reverse. The educational foundation was never built to sustain what the oil financed.

**Education without energy endowment: the leapfrog cases.** Japan imports virtually all its oil, coal, and gas. South Korea has negligible domestic energy reserves. Taiwan, Singapore, and Switzerland have none. All achieved full development by the measures in Table 4, and all rank among the highest-income economies on earth. The mechanism is what the education-primary account predicts: educated workforces attract and efficiently deploy imported energy into high-value production, developing the institutional capacity to pay for energy imports through manufactured exports. An educated South Korean factory worker produces more value per barrel of imported oil than a Venezuelan oil field produces per barrel extracted — because education converts energy surplus into complexity and compounding rather than rents and consumption.

Bangladesh is the extreme case: GDP per capita of $1,250 in 2015, no significant energy endowment, crossing both development thresholds through female secondary education expansion alone. The welfare gains that matter for development — lower fertility, longer life expectancy — are generated primarily through household micro-decisions that require minimal energy input. A literate mother who understands vaccination schedules, birth spacing, and oral rehydration does not need electricity to keep her children alive longer and choose to have fewer of them. The micro-decision pathway operates below the energy threshold at which material production begins. Bangladesh refutes both the income-primary and the energy-primary accounts simultaneously.

**The Ayres-Warr finding and the Solow residual.** This framework extends to explaining what standard growth accounting cannot. Solow (1957) found that capital and labor together explained only approximately 20% of US economic growth 1909–1949; the remaining 80% he attributed to unexplained "technical change" (total factor productivity, TFP). Ayres and Warr (2009) showed that adding "useful work" — energy converted into economic output, adjusted for efficiency improvements — largely dissolves this residual. The "mysterious" productivity gains of the 20th century are substantially the story of electrification, motorization, and the educated deployment of fossil fuel energy into production. The mystery dissolves when you measure the physics. But the mechanism beneath the energy story is still education: it was the educated engineering class — in Scotland, Germany, and America — that designed the steam engine, the internal combustion engine, and the electrical grid; the educated workforce that operated them at increasing efficiency; and the educated populations that built the political demand for the energy infrastructure that distributed the gains. Energy enabled the surplus; education determined its structure, efficiency, and distribution.

**Why education remains the primary policy variable.** Energy, unlike education, is internationally tradeable: South Korea imports it; Bangladesh can access it at world prices when its economy develops to the point of needing it. What is not tradeable is an educated population. No country has imported a population's capacity to make better household decisions, demand better governance, or build the technical and institutional infrastructure of a modern economy. The binding constraint at the development frontier is not energy access — it is the educational foundation that determines whether energy, once available, converts into compounding human welfare or into extraction rents captured by elites and foreign supply chains. The resource curse countries demonstrate this precisely: they solved the energy constraint and failed at the development threshold because they had not solved the education constraint. Korea and Taiwan solved the education constraint first and let energy access follow from the economic complexity that educated populations generate.

The full account of human development is therefore two-variable: energy sets the physical ceiling; education determines how much of that ceiling is reached and whether gains compound. Everything else — income, institutions, welfare provision, the political form of states — is downstream of both. Smith described what educated populations do with energy surplus and called it the wealth of nations. He was not wrong about the description. He was wrong about the cause.

**The SWB revolution and the dissolution of geological energy endowment as a differentiating variable.** The historical energy argument — that coal, then oil, then gas determined which nations could industrialize — rested on the geological concentration of fossil fuels in specific locations. Energy was scarce, location-specific, and the exclusive advantage of nations that happened to sit above deposits or control the supply chains that moved them. This is changing permanently. Solar photovoltaics have followed Wright's Law — approximately 30% cost reduction per doubling of cumulative production — from $76 per watt in 1977 to under $0.20 per watt in 2024. Wind has followed similar learning curves. Battery storage costs have declined approximately 90% over the decade to 2024. Seba (2014) documents the inflection point: at current learning rates, solar, wind, and batteries (SWB) represent the cheapest form of new energy generation in virtually every market on earth before 2030, and will displace fossil fuel incumbents not through regulation but through cost. Subsequent RethinkX analyses (Seba & Arbib 2017; RethinkX 2021) project that by 2030 the majority of new energy capacity globally will be SWB, with stranded fossil fuel assets potentially exceeding $25 trillion.

The structural implication for development economics is profound. Solar energy harvests sunlight, and sunlight falls on every country approximately equally — with the irony that it falls most abundantly on the equatorial regions where development has been slowest. The energy endowment advantage of fossil fuel states dissolves as SWB learning curves continue. Saudi Arabia, Venezuela, Nigeria, and Qatar face the same transition: their primary asset — control of a scarce, geologically concentrated energy source — is becoming a stranded liability. The resource curse that characterized fossil-fuel-rich, education-poor countries in the 20th century becomes an existential threat in the 21st. The rent stream funding their state apparatus and provision dries up at precisely the moment they lack the educated population to build an alternative economic base. Venezuela's 2014–2020 collapse is the early iteration of a structural pattern that will recur across petrostates as SWB cost curves continue their descent.

The inverse is equally consequential. Korea, Taiwan, Japan, and Bangladesh built development trajectories on educated populations deploying imported energy efficiently; they will transition to SWB with less disruption because their economic complexity already depends on intelligent energy conversion rather than resource extraction. The educational foundation that enabled them to escape the resource-curse trap in the 20th century positions them to lead the energy transition in the 21st. Educated engineers and institutional capacity are precisely what the SWB buildout requires; they are not what oil fields require.

For countries below the development threshold today, the SWB revolution creates a structural possibility that did not exist for earlier developers: **energy leapfrogging**. Just as mobile telephony enabled countries to skip fixed-line infrastructure entirely, distributed solar-plus-battery systems allow countries to deploy household and community energy access without building centralized fossil fuel grids. The micro-decision pathway that is the core of PTE — educated mothers making household health and fertility decisions — operates at energy scales that distributed solar already reaches at low-income price points. The minimum energy required for a literate woman to read health information, run a light for evening study, or charge a phone connecting her to vaccination scheduling does not require a national grid. It requires a solar panel and a battery. Both are approaching cost structures compatible with low-income household access without subsidy.

The long-run consequence is that energy converges toward a universal floor. The SWB transition eliminates the absolute energy scarcity constraint for the minimum welfare threshold — distributed solar and batteries make basic energy access achievable for every country regardless of geological endowment, at declining cost. When that floor is reached, the differentiating variable between nations is no longer geological luck. It is purely educational. The two-variable account — energy ceiling, education efficiency multiplier — is not wrong, but it is transitional: a description of the fossil fuel era. The endpoint of the SWB revolution is a world in which the energy ceiling is approximately equal across all nations, and the sole differentiating variable is precisely what this paper argues it always was at the level of household welfare: the educated population that determines whether available energy converts into compounding human welfare.

### 2.5 The Two Pathways from an Educated Population
...
The state's role is precisely defined: initiate the rupture and sustain it all the way to near-universal completion. Korea ran simultaneous primary and secondary expansion from 1953 with sustained state commitment across successive governments for three decades, from 24.8% in 1950 to 94.4% in 1985 — with no point at which the state stepped back. Korea crossed 40% in 1960 and continued at full pace for another 25 years. As household demand strengthens progressively with rising parental education, the state and households work together — but state investment is the initiating and sustaining force throughout.
...
The rupture activates both pathways simultaneously. The same cohort of educated citizens makes better household decisions (Pathway 1) and builds the political demand for institutions and services (Pathway 2). Sen's two pathways are not sequential alternatives — they fire in parallel as the educational expansion compounds. What looks like "growth-mediated" security (Korea) and "support-led" security (Kerala) are the same mechanism expressing itself differently — education compounding through households, activating micro-decisions and political agency simultaneously.

The failure mode is the absence of the rupture — treating education as one priority among many. The data identifies this precisely: countries at low completion levels face a structural problem where parental baselines are too low and fertility too high for the demographic transition to make rapid progress — PTE still advances the system, but slowly, against the headwind of rapid population growth and thin household resource constraints. Approximately 33 million young people in those 27 countries alone are not completing lower secondary — authors' calculations from WCDE v3 completion rates and World Bank population data, 2015. For them, state commitment to education above the demographic baseline is the only available mechanism. Growth will not initiate it (income is downstream); direct provision of health and nutrition services will not initiate it — provision produces temporary gains that do not compound, and every fiscal dollar spent on provision rather than education delays the only mechanism that does. Only the educational rupture starts the compounding — and only sustained state education policy, maintained all the way to near-universal completion, sustains it.
...
RethinkX. (2021). *Rethinking Energy 2020–2030: 100% Solar, Wind, and Batteries is Just the Beginning*. RethinkX.

Seba, T. (2014). *Clean Disruption of Energy and Transportation: How Silicon Valley Will Make Oil, Nuclear, Natural Gas, Coal, Electric Utilities and Conventional Cars Obsolete by 2030*. Clean Planet Ventures.
