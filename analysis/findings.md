...
1. **Causality.** The findings are observational, not experimental. The credible alternative explanations are: (a) **state capacity** — governments capable of building school systems may also do other growth-enabling things, with education and development as co-outputs of the same underlying governance quality; (b) **cultural selection** — communities that prioritise education may have other characteristics (future orientation, savings behaviour) that independently drive outcomes. Neither alternative fully escapes education as the mechanism. State capacity requires literate administrators and technocrats — it runs through education. Cultural shifts toward lower fertility and higher investment operate substantially through what schooling does to individuals: literacy enables health information access, numeracy enables financial planning, institutional experience changes how people interact with markets and governments. Education occupies 8–15 years of active cognitive and social development; it is not a passive marker that could correlate with outcomes by coincidence. The remaining genuine uncertainty is whether the education variable partly proxies for state capacity rather than being the sole mechanism. The policy implication is unchanged: you cannot build state capacity without educating people.
...
3. **Reverse causality is largely resolved by the lagged structure.** The central generational transmission finding uses parental education from T−25 predicting child education at T. A child's future health or life expectancy cannot cause their parent's education 25 years earlier — the temporal direction is fixed. For the education→TFR→life expectancy pathway, the cohort definition already places female education at ~T−15, again before the TFR and life expectancy outcomes it predicts. The one place reverse causality remains a genuine concern is the contemporaneous GDP→life expectancy channel (Finding 5) — healthier populations may be more productive — but this does not affect the education findings.
